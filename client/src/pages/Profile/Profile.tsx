...
//     // Gửi ảnh lên backend và cập nhật avatar
...
//         formDataToSend.append("avatar", selectedFile); // Tên trường 'avatar' backend sẽ nhận
//         formDataToSend.append("user_id", formData.user_id.toString());

//         axios
//             .post("http://localhost:3000/api/user/upload-avatar", formDataToSend, {
//                 headers: {
...
//                 // Cập nhật lại avatar trong formData sau khi upload thành công
//                 setFormData({ ...formData, avatar: response.data.avatar }); // Giả sử backend trả về URL mới của avatar
//             })
//             .catch((error) => {
...
//     api_key: "459516937217526",
//     api_secret: "E438yRKB0Nl15dNmzPjyB-gf7N4",
// });
...
//         cloudinary.uploader.upload(formDataToSend, function (error, result) {
//             if (error) {
//                 console.error("Error uploading avatar to Cloudinary:", error);
//             } else {
//                 const avatarUrl = result.secure_url; // URL của ảnh đã tải lên
//                 // Cập nhật avatar URL trong database
//                 axios
//                     .post("http://localhost:3000/api/user/upload-avatar", {
